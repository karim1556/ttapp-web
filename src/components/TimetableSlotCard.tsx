  ...
  if (isBreak) {
    return (
      <div className="flex items-center gap-3 rounded-2xl border border-border bg-break-bg px-4 py-3">
        ...
        <div className="flex items-center gap-2 text-sm font-semibold text-break-text">
          Break / Free Slot
        </div>
      </div>
    )
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <span
              className={`rounded-lg px-2 py-1 text-[11px] font-semibold ${
                isLab ? 'bg-lab-bg text-lab-text' : 'bg-brand-light text-brand'
              }`}
            >
              {isLab ? 'Lab' : 'Lecture'}
            </span>
